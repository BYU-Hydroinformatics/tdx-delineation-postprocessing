...
def CreateComidLatLonZ(network: str, out_dir: str, id_field: str) -> None:
    """
    Create a comid_lat_lon_z csv in output directory, based on an input drainage line network.
